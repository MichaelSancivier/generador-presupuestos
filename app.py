...
# En una aplicación real, lo cargarías desde un archivo.
...
with st.form("formulario_presupuesto"):
    ...
    numero_orcamento = st.text_input("Número de Presupuesto", "MPF-1")
...
if submitted:
    ...
    try:
        ...
        st.download_button(
            label="📥 Descargar PDF",
            data=pdf_data,
            file_name=f"presupuesto-{cliente_nombre}.pdf",
